...
public class PostDetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        summary = formatBody(summary);
        logger.info(summary);
        binding.postDetailBody.loadDataWithBaseURL(null, summary, "text/html; charset=UTF-8", null, null);
        binding.postDetailBody.setOnLongClickListener(v -> true);
