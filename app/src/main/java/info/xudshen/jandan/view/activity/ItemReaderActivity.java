...
public class ItemReaderActivity extends BaseActivity implements HasComponents, ActionView {
    ...
    protected void onResume() {
        ...
        this.commentAreaName.setText(JandanSettingActivity.getSettingUsername(this));
        this.commentAreaEmail.setText(JandanSettingActivity.getSettingUseremail(this));
    }
    ...
    protected void onPause() {
        ...
        JandanSettingActivity.setSettingUsername(this, this.commentAreaName.getText().toString());
        JandanSettingActivity.setSettingUseremail(this, this.commentAreaEmail.getText().toString());
    }
