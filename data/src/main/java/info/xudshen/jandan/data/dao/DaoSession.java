...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession setContext(Context context) {
        ...
        picCommentDao.setContext(context);
        return this;
    }
    ...
    private final DaoConfig picCommentDaoConfig;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        picCommentDaoConfig = daoConfigMap.get(PicCommentDao.class).clone();
        picCommentDaoConfig.initIdentityScope(type);
        ...
        picCommentDao = new PicCommentDao(picCommentDaoConfig, this);
        ...
        registerDao(PicComment.class, picCommentDao);
    }
    ...
    public void clear() {
        ...
        picCommentDaoConfig.getIdentityScope().clear();
    }
