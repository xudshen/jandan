...
public class Property {
    ...
    public static class PropertyBuilder {
        ...
        public PropertyBuilder propertyDefault(String propertyDefault) {
            property.propertyDefault = propertyDefault;
            return this;
        }
        ...
        public PropertyBuilder customType(String customType, String converter) {
            ...
            property.converter = DaoUtil.getFullyQualifiedClassnameFromFullyQualified(converter);
    ...
    public String getEntityValueExpression(String databaseValue) {
        ...
        if (customType != null) {
            ...
            builder.append(customTypeClassName).append(".class, ");
        }
